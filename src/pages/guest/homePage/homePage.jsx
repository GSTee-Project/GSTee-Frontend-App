  ...
  return (
    <>
      ...
      <div className={styles.home_page}>
        ...
        <section id='features' className={styles.perks_section}>
        ...
        <section id='testimonials' className={styles.testimonial_section}>
